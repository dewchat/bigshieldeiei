    ...
    <div>
      ...
      <div style={{ padding: '10px 30px 10px 30px' }}>
        <form onSubmit={handleSubmit}>
          ...
          <h3>กลุ่มเป้าหมาย: เด็กและเยาวชน</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: ผู้สูงอายุ</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: ผู้ป่วยติดเตียง</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: สตรีและครอบครัว</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: ผู้ป่วยเอดส์</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: ทหารผ่านศึก</h3>
          <div>
            <label>
              <input
                type="checkbox"
          ...
          <h3>กลุ่มเป้าหมาย: ประชาชนทั่วไป</h3>
          <div>
            <label>
              <input
                type="checkbox"
